                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('anggota.create') }}" class="btn btn-info m-0">Tambah Data Anggota</a>
                                <a href="{{ route('cetak-anggota') }}" target=_blank class="btn btn-warning m-2">Cetak Data Anggota</a>
                                <div class="row">
