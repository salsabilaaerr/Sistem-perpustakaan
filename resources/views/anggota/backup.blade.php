                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('cetak-anggota') }}" target="_blank" class="btn btn-danger m-2">Cetak Data Anggota</a>
                                <div class="row">
                                    <table class="table">
                                        <thead>
                                            <tr>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <div class="pull-right">
          <a href="{{ route('logout')}}" class="btn btn-default btn-flat bg-red" onclick="event.preventDefault();
