                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('peminjaman.edit', $v->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                            <button class="btn btn-danger btn-sm">Hapus</button>
                                            <a href="{{ route('pengembalian.prosespengembalian', $v->id) }}" class="btn btn-secondary btn-sm">Kembalikan</a>
                                        </td>
                                    </tr>
                                     </tbody>
                                    @endforeach
